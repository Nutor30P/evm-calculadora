...
export default function VideoExplainer({ theme }) {
  ...
  return (
    <Section
      ...
      tone="surface"
      icon="🎥"
      kicker="Míralo en video"
      title="Un repaso animado de todo el proceso EVM"
      subtitle="Los mismos conceptos de esta página, explicados en un par de minutos. Ideal para repasar rápido o para explicarle el tema a alguien que recién empieza."
    >
      <div
        style={{
          position: "relative",
